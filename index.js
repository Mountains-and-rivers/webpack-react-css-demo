...
_reactDom2.default.render(_react2.default.createElement(_frame2.default, null), document.getElementById('index'));
...
var IndexFrame = function (_Component) {
    _inherits(IndexFrame, _Component);

    function IndexFrame() {
        _classCallCheck(this, IndexFrame);

        return _possibleConstructorReturn(this, (IndexFrame.__proto__ || Object.getPrototypeOf(IndexFrame)).apply(this, arguments));
    }

    _createClass(IndexFrame, [{
        key: 'render',
